...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $.ajax({
                type: 'GET',
                url: 'http://localhost:50712/Default.aspx/GetDetails',
        ...
        function update(id, item) {
            ...
            if ($('#id_' + id).find('td:first').children().children().hasClass("fa-minus-circle") == false) {
                ...
                if (flag == false) {
                    ...
                    $('#thheadtotal').html("");
                    $('#thheadtotal').html("Acc/No" + "<span style='margin-left: 72px;'>Total</span>");
                }
                else {
                    $('#id_' + id).find('td:first').find('i').removeClass('fa-plus-circle').addClass('fa-minus-circle');
                    //Get Data For Selected Value From DataBase
        ...
        function update1(id, item) {
            ...
            if ($('#firstLevel_' + id).find('td:first').find('i').hasClass('fa-minus-circle') == false) {
                ...
                if (flagLevel1 == false) {
                    ...
                    $('#thheadtotal').html("");
                    $('#thheadtotal').html("<span>Acc/No</span>" + "<span style='margin-left: 72px;'>Profit Center</span>" + "<span style='margin-left: 80px;'>Total</span>");
                }
        ...
        function update2(id, item) {
            ...
            if ($('#secondlevel_' + id).find('td:first').children().children().hasClass("fa-minus-circle") == false) {
                ...
                if (flagLevel2 == false) {
                    ...
                    $('#thheadtotal').html("<span>Acc/No</span>" + "<span style='margin-left: 72px;'>Profit Center</span>" + "<span style='margin-left: 80px;'>Cost Center</span>" + "<span style='margin-left: 60px;'>Total</span>");
        ...
        function update3(id, item) {
            ...
            if ($('#thirdlevel_' + id).find('td:first').children().children().hasClass("fa-minus-circle") == false) {
                ...
                if (flagLevel3 == false) {
                    ...
                    $('#thheadtotal').html("<span>Acc/No</span>" + "<span style='margin-left: 72px;'>Profit Center</span>" + "<span style='margin-left: 80px;'>Cost Center</span>" + "<span style='margin-left: 60px;'>Order Number</span>" + "<span style='margin-left: 65px;'>Total</span>");
