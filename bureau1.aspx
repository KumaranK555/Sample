<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bureau1.aspx.cs" Inherits="bureau1" %>
   ...
   <style type="text/css">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $.ajax({
                type: 'GET',
                url: 'http://localhost:52658/bureau1.aspx/GetDetails',
                ...
                success: function (data) {
                    ...
                    $.each(data.d, function (i) {
                        ...
                        if (data.d[i].Group == 'NEWF2') {
                            html += "<tr id='" + trid + "' style='color: blue;font-weight: bold;' class='section'><td>" + data.d[i].Head + "<span onclick='updatebureautrend(\"" + i + "\",\"" + input + "\")'><i class='fa fa-plus-circle' aria-hidden='true' ></i></span></td><td>" + data.d[i].Total + "</td></tr>";
                        }
                        else if (data.d[i].Group == 'NEWF3') {
                            html += "<tr id='" + trid + "' style='color: red;font-weight: bold;'><td>" + data.d[i].Head + "<span onclick='updatebureautrend(\"" + i + "\",\"" + input + "\")'><i class='fa fa-plus-circle' aria-hidden='true' ></i></span></td><td>" + data.d[i].Total + "</td></tr>";
                        }
                        else {
                            html += "<tr  id='" + trid + "' style='font-weight: bold;'><td>" + data.d[i].Head + "<span onclick='updatebureautrend(\"" + i + "\",\"" + input + "\")'><i class='fa fa-plus-circle' aria-hidden='true' ></i></span></td><td>" + data.d[i].Total + "</td></tr>";
                        }
                ...
                if (flag == false) {
                    ...
                    if (accobj.length > 0) {
                        ...
                        $.each(accobj, function (i, data) {
                            ...
                            html += "<tr id='firstLevel_" + dynID + "'><td>" + data.AccountNumber + "<span onclick='updatebureautrend1(\"" + dynID + "\",\"" + input + "\")'><i class='fa fa-plus-circle' aria-hidden='true'></i></span></td><td>" + data.Total + "</td></tr>";
                        });
                        html += '</table>';
                    }
                    ...
                    $('#thheadtotal').html("");
                    $('#thheadtotal').html("GLName" + "<span style='margin-left: 72px;'>Total</span>");
                }
                else {
                    $('#id_' + id).find('td:first').find('i').removeClass('fa-plus-circle').addClass('fa-minus-circle');
                    //Get Data For Selected Value From DataBase
                ...
                if (flagLevel1 == false) {
                    ...
                    if (accobj.length > 0) {
                        ...
                        $.each(accobj, function (i, data) {
                            ...
                            html += "<tr id='secondlevel_" + dynID + "'><td>" + data.AccountNumber + "<span onclick='updatebureautrend2(\"" + dynID + "\",\"" + input + "\")'><i class='fa fa-plus-circle' aria-hidden='true'></i></span></td><td>" + data.Total + "</td></tr>";
                    ...
                    //    {
                    //        $(data).find("td:last").html("<table><tr><qtd>&nbsp</td></tr></table>")
                    //    }
                    //});
                    ...
                    $('#thheadtotal').html("");
                    $('#thheadtotal').html("<span>GLName</span>" + "<span style='margin-left: 72px;'>AccNo</span>" + "<span style='margin-left: 80px;'>Total</span>");
                }
        ...
        function updatebureautrend2(id, item) {
            ...
            if ($('#secondlevel_' + id).find('td:first').children().children().hasClass("fa-minus-circle") == false) {
                ...
                if (flagLevel2 == false) {
                    ...
                    if (accobj.length > 0) {
                        ...
                        $.each(accobj, function (i, data) {
                            ...
                            html += "<tr id='thirdlevel_" + dynID + "'><td>" + data.AccountNumber + "<span onclick='updatebureautrend3(\"" + dynID + "\",\"" + input + "\")'><i class='fa fa-plus-circle' aria-hidden='true'></i></span></td><td>" + data.Total + "</td></tr>";
                    ...
                    $('#thheadtotal').html("<span>GLName</span>" + "<span style='margin-left: 72px;'>AccNo</span>" + "<span style='margin-left: 72px;'>Profit Center</span>" +  "<span style='margin-left: 60px;'>Total</span>");
                ...
                $('#thheadtotal').html("<span>GLName</span>" + "<span style='margin-left: 72px;'>Acc No</span>" + "<span style='margin-left: 80px;'>Total</span>");
                flagLevel2 = false;
        ...
        function updatebureautrend3(id, item) {
            ...
            if ($('#thirdlevel_' + id).find('td:first').children().children().hasClass("fa-minus-circle") == false) {
                ...
                if (flagLevel3 == false) {
                    ...
                    if (accobj.length > 0) {
                        ...
                        $.each(accobj, function (i, data) {
                            ...
                            html += "<tr id='fourthlevel_" + dynID + "'><td>" + data.AccountNumber + "<span onclick='updatebureautrend4(\"" + dynID + "\",\"" + input + "\")'><i class='fa fa-plus-circle' aria-hidden='true'></i></span></td><td>" + data.Total + "</td></tr>";
                        });
                        html += '</table>';
                    }
                        ...
                        html += "<tr id='fourthlevel_nan' ><td>0<span onclick='updatebureautrend4(\"" + dynID + "\",\"" + input + "\")'><i class='fa fa-plus-circle' aria-hidden='true'></i></span></td><td>0</td></tr>";
                ...
                $('#thheadtotal').html("<span>GLName</span>" +"<span style='margin-left: 410px;'>Acc No</span>" + "<span style='margin-left: 410px;'>Profit Center</span>" +  "<span style='margin-left: 35px;'>Total</span>");
                flagLevel3 = false;
        ...
        function updatebureautrend4(id, item) {
            ...
            if ($('#fourthlevel_' + id).find('td:first').children().children().hasClass("fa-minus-circle") == false) {
                ...
                if (flagLevel4 == false) {
                    ...
                    $('#thheadtotal').html("<span>Acc/No</span>" + "<span style='margin-left: 72px;'>GL Name</span>" + "<span style='margin-left: 72px;'>Profit Center</span>" + "<span style='margin-left: 80px;'>Cost Center</span>" + "<span style='margin-left: 80px;'>Order Number</span>" + "<span style='margin-left: 65px;'>Total</span>");
                    ...
                    if (accobj.length > 0) {
                        ...
                        $.each(accobj, function (i, data) {
                            ...
                            html += "<tr id='fourthlevel_" + dynID + "'><td>" + data.AccountNumber + "<span onclick='update4(\"" + dynID + "\",\"" + input + "\")'><i class='fa fa-plus-circle' aria-hidden='true'></i></span></td><td>" + data.Total + "</td></tr>";
        ...
        function getfifthleveldetails(id,item)
        {
            var accobjlist = null;
            Cost = item;
            $.ajax({
...
<body>
    <form id="form1" runat="server">
            <div class="table-responsive">
                    ...
                    <table class="table table-striped table-bordered table-hover no-margin tab-blk tab_cls"  id="tblbureaureport1" >
                        <thead>
                            <tr>
